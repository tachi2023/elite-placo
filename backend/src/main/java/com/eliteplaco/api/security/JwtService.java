...
public class JwtService {
    ...
    public String genererAccessToken(String identifiant) {
        return genererToken(identifiant, accessTokenExpirationMs);
    }

    public String genererRefreshToken(String identifiant) {
        return genererToken(identifiant, refreshTokenExpirationMs);
    }

    private String genererToken(String identifiant, long dureeMs) {
